...
#   c) node1 mines 32 blocks, so now node 0 has 500000FRENCH, node 1 has 4250FRENCH, node2 has none.
#   d) node0 sends 601 FRENCH to node2, in two transactions (301 FRENCH, then 300 FRENCH).

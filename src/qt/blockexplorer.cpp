...
static std::string ValueToString(CAmount nValue, bool AllowNegative = false)
{
    ...
    QString Str = BitcoinUnits::formatWithUnit(BitcoinUnits::FRENCH, nValue);
...
{
    std::string genesisblockhash = "00000ee1d29715a7ccf1ce7c17791037d73c495a4ee0b4feb0d4d01d96ccacbd";

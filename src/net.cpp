...
{
    if (pszDest == NULL) {
        // we clean masternode connections in CFrenchnodeMan::ProcessFrenchnodeConnections()
        // so should be safe to skip this and connect to local Hot MN on CActiveFrenchnode::ManageStatus()
